        ...
        <CardContent className="p-8 sm:p-12">
          <div className="text-center space-y-8">
            ...
            <div className="space-y-6 text-lg sm:text-xl text-muted-foreground leading-relaxed">
              <p>
                Valora helps mortgage brokers speed up client document checks.
              </p>
              ...
              <p>
                Valora will analyze the documents, highlight strengths, flag weaknesses, 
                and show any missing information in the loan application. You can export 
                the results as a PDF to share with your client.
              </p>
              
              <p>
                Manage multiple clients in your Valora dashboard. All data stays safe and 
